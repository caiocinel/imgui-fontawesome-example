...
int main(int, char**)
{
    ...
    while (!done)
    {
...

        {
            ...
            ImGui::Checkbox("With checkbox " ICON_FA_RECYCLE, &checkbox);

            ImGui::SliderFloat("Label is " ICON_FA_FACE_SMILE_WINK, &f, 0.0f, 1.0f);
            ImGui::SliderFloat("##", &f2, 0.0f, 1.0f, "Omg it\'s %f" ICON_FA_BELL);

            if (ImGui::Button("Press Me " ICON_FA_THUMBS_UP))
                counter++;
            ImGui::SameLine();
        ...
        const float clear_color_with_alpha[4] = { 0 * 0, 0, 0, 0 };
